...
export default function(props) {
    return (
        <svg viewBox="188.437 138.345 238.379 238.565" className={props.className}>
        <g transform="matrix(0.1, 0, 0, -0.1, 186.937469, 376.909698)" fill={'currentColor'} stroke="none">
